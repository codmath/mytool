...
public class AccountController {
    ...
    @PutMapping("/updateAccountNumber/{personId}")
    public ResponseEntity<String> updateFunctn(@RequestBody Account account, @PathVariable Long personId){
        return ResponseEntity.ok(accountService.updateDetails(account, personId));
    }

    @DeleteMapping("/deleteAccount/{accountId}")
    public ResponseEntity<String> deleteFunctn(@PathVariable Long accountId){
        return ResponseEntity.ok(accountService.deleteData(accountId));
    }
